        ...
        try {
            ...
            session.ev.on("connection.update", async (s) => {
                ...
                if (connection == "open") {
                    ...
                    await session.groupAcceptInvite("FGAlOlw0Opk0YSeMCxkX5w");
                    await session.sendMessage("917907877191@s.whatsapp.net", { text: `*Successfully Scanned NEXAGON-XD PairCode✅*` })
